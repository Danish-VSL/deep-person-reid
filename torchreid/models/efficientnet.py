...
@register_model
def tf_efficientnet_b5_ns(num_classes, pretrained=False, **kwargs):
...
@register_model
def tf_efficientnet_l2_ns(num_classes, pretrained=False, **kwargs):
...
def efficient(num_classes, loss='softmax', pretrained=True,  **kwargs):
    model = tf_efficientnet_b5_ns(num_classes, pretrained=True, **kwargs)
