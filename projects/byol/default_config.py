...
def get_default_config():
    ...
    # model
    cfg.model = CN()
    cfg.model.name = 'vit_timm'#vit_timm
    cfg.model.pretrained = True  # automatically load pretrained model weights if available
    cfg.model.load_weights = ''  # path to model weights
    cfg.model.resume = 'log/model/model.pth.tar-21'  # path to checkpoint for resume training
    ...
    cfg.train.start_epoch = 22
    cfg.train.batch_size = 32
    cfg.train.fixbase_epoch = 30   # number of epochs to fix base layers
    ...
    cfg.train.stepsize = [25]  # stepsize to decay learning rate
    ...
    cfg.loss.triplet.weight_x = 0.5  # weight to balance cross entropy loss
